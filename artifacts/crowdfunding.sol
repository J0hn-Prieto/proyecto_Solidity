...
contract CrowdFunding {
    ...
    uint public deadline; // tiempo de campaña
    uint public targetAmount; // objetivo de la campaña
    ...
    // esta funcion permite hacer la donación a mi contrato
    function sendFunds() public payable  {
        require(block.timestamp < deadline, "El plazo a terminado");
    ...
    // me permite transferir los fondos del contrato una vez se cumplan las condiciones de tiempo y valor
    ...
    // si se cumplio el objetivo y el que lo ejecuta es el manager puedo sacar dinero a un tercero
    ...
    // esta funcion me permite hacer el pago de la funcion anterior
